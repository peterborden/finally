...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/family/projects/peterai/finally2/finally/.claude/.gsd-surface.json`
(sibling to `/Users/family/projects/peterai/finally2/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/family/projects/peterai/finally2/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/family/projects/peterai/finally2/finally/.claude/skills`).
...
`/Users/family/projects/peterai/finally2/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/family/projects/peterai/finally2/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/family/projects/peterai/finally2/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/family/projects/peterai/finally2/finally/.claude/.gsd-profile`
Skill dirs: `/Users/family/projects/peterai/finally2/finally/.claude/skills/gsd-*/`
Engine module: `/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
