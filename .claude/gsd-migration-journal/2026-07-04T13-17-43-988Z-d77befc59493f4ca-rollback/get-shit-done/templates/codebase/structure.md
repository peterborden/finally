...
- Usage: Reference from command with `@/Users/family/projects/peterai/finally2/finally/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/family/projects/peterai/finally2/finally/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/family/projects/peterai/finally2/finally/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
