...
```bash
INIT=$(node "/Users/family/projects/peterai/finally2/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/family/projects/peterai/finally2/finally/.claude/get-shit-done/templates/spec.md.
