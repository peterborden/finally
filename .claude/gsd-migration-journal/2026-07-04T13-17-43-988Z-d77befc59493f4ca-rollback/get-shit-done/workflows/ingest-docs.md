...
```bash
INIT=$(node "/Users/family/projects/peterai/finally2/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/family/projects/peterai/finally2/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
