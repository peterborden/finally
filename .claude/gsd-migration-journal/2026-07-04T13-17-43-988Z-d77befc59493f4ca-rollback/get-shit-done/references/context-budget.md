...
The keys live in `.claude/settings.json` (project) or `/Users/family/projects/peterai/finally2/finally/.claude/settings.json` (global) — **not** in `.planning/config.json`:
