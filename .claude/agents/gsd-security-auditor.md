...
**Verification depth scales with `asvs_level`** (see @/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
