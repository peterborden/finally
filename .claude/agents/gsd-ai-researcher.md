...
<required_reading>
Read `/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
