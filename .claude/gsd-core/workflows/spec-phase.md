...
ones). Reference: @/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/family/projects/peterai/finally2/finally/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/family/projects/peterai/finally2/finally/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/templates/spec.md.
