...
<required_reading>
@/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/domain-probes.md
@/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/gate-prompts.md
@/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
...
```
Apply each entry in `activeHooks` per @/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `analyze_phase`.
</step>
...
```
Apply each entry in `activeHooks` per @/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/references/loop-hook-dispatch.md. Empty list → continue to `confirm_creation`.
</step>
