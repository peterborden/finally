...
```
Agent(
  prompt="Read /Users/family/projects/peterai/finally2/finally/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/templates/VALIDATION.md`
