...
INSTALL_JS_GLOBAL="/Users/family/projects/peterai/finally2/finally/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/family/projects/peterai/finally2/finally/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
