...
- [ ] 02-01-PLAN.md — Watchlist API: GET/POST/DELETE /api/watchlist wired to the market source (WATCH-01, WATCH-02, WATCH-03)
- [ ] 02-02-PLAN.md — Pure trade engine: buy/sell average-cost math, fractional shares, insufficient-cash/shares rejection (PORT-03, PORT-04)
- [ ] 02-03-PLAN.md — Portfolio + trading endpoints: GET /api/portfolio, POST /api/portfolio/trade, GET /api/portfolio/history, immediate snapshot (PORT-01, PORT-02, PORT-03, PORT-05, PORT-06)
...
| 2. Watchlist & Trading APIs | 0/4 | Not started | - |
